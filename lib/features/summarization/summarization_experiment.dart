...
import 'summarization_controller.dart';

enum SummarizationPresentation { technical, everyday }

class SummarizationExperiment extends StatelessWidget {
  ...
  final SummarizationController controller;
  final SummarizationPresentation presentation;
  ...
  Widget build(BuildContext context) {
    switch (presentation) {
      case SummarizationPresentation.technical:
        return _buildTechnical(context);
      case SummarizationPresentation.everyday:
  ...
  Widget _buildTechnical(BuildContext context) {
    ...
    final hasValidInput = controller.inputController.text.length > 400;
    final progress =
    ...
    return Column(
      ...
      children: [
        ...
        FilledButton.icon(
          ...
          label: Text(
            controller.isChecking ? 'Checking…' : 'Check summarization status',
          ),
        ),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            helperText: '${controller.inputController.text.length} characters',
            errorText: controller.inputController.text.isEmpty || hasValidInput
                ? null
        ...
        FilledButton.icon(
          ...
          label: Text(controller.isRunning ? 'Summarizing…' : 'Summarize'),
        ),
        const SizedBox(height: 16),
        Card(
          child: Padding(
      ...
      children: [
        ...
        FilledButton.icon(
          ...
          icon: controller.isRunning
              ...
              : const Icon(Icons.play_arrow),
          label: Text(
            controller.isRunning ? 'Summarizing…' : 'Run summary test',
          ),
        ),
        const SizedBox(height: 12),
  ...
  Color _statusColor(ColorScheme colors) {
    switch (controller.status) {
      ...
      case 'DOWNLOADING':
        return presentation == SummarizationPresentation.everyday
            ? colors.primary
            : Colors.blue;
      case 'CHECKING':
        return presentation == SummarizationPresentation.everyday
